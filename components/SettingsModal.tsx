...
import { Language, ImageModel, VideoModel, VideoStyle, AspectRatio, VideoQuality, VideoDuration, VideoFps, VideoResolution, MODEL_COSTS, MODEL_METADATA, STYLE_PRESETS } from '../types';
      ...
      <div className="bg-slate-900 border border-slate-700 rounded-xl w-full max-w-lg p-6 shadow-2xl overflow-y-auto max-h-[90vh]">
        ...
        <div className="space-y-5">
          ...
          <div className="grid grid-cols-2 gap-4">
            {/* Video Model Selector - REBUILT FOR ALL-STAR LINEUP */}
            <div className="col-span-2">
              ...
              >
                {/* 1. ENTRY / DRAFT */}
                <optgroup label="🟢 Draft & Value">
                   <option value="wan_2_5">
                     {getModelLabel('wan_2_5')} (💎 {MODEL_COSTS.wan_2_5})
                   </option>
                </optgroup>

                {/* 2. STANDARD / MOTION */}
                <optgroup label="🔵 Standard Motion">
                   <option value="hailuo_02">
                     {getModelLabel('hailuo_02')} (💎 {MODEL_COSTS.hailuo_02})
                   </option>
                   <option value="veo_3_1">
                     {getModelLabel('veo_3_1')} (💎 {MODEL_COSTS.veo_3_1})
                   </option>
                   <option value="pixverse_v5">
                     {getModelLabel('pixverse_v5')} (💎 {MODEL_COSTS.pixverse_v5})
                   </option>
                </optgroup>
                
                {/* 3. PRO / AUDIO / FLAGSHIP */}
                <optgroup label="🟡 Pro Audio-Visual">
                   <option value="seedance_1_5_pro">
                     {getModelLabel('seedance_1_5_pro')} (💎 {MODEL_COSTS.seedance_1_5_pro})
                   </option>
                   <option value="sora_2_pro">
                     {getModelLabel('sora_2_pro')} (💎 {MODEL_COSTS.sora_2_pro})
                   </option>
                </optgroup>
              </select>
              ...
              <div className="mt-2 flex flex-wrap gap-2">
                 {MODEL_METADATA[videoModel].badge && (
                    <span className={`text-[10px] px-2 py-1 rounded font-bold border
                      ${videoModel === 'wan_2_5' ? 'bg-green-500/10 text-green-400 border-green-500/20' : ''}
                      ${(videoModel === 'seedance_1_5_pro' || videoModel === 'sora_2_pro') ? 'bg-amber-500/10 text-amber-400 border-amber-500/20' : ''}
                    `}>
                       {MODEL_METADATA[videoModel].badge}
                    </span>
                 )}
